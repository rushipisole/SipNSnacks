...
<head>
    ...
    <link rel="icon" href="#">
    <title>Welcome To Sip n Snacks</title>
...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/indian-condiments-with-copy-space-view.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Welcome To Sip n Snacks <h1>Indias famous Site ever!!  </h1>
